# -*- coding: utf-8 -*-
"""
Created on Sun Aug 23 14:34:08 2020

@author: Willi
"""

"""
Gran parte del código es gracias a: https://github.com/evanll/liwc-text-analysis-python/blob/master/liwc/liwc.py
Para poder utilizarlo con un diccionario en Español he tenido que realizar algunos ajustes, también añadí la función
para que devuelva un dataframe
"""
...
ruta = str(Path(os.path.realpath(__file__)).parent)+"\\LIWC_Spanish.dic"
...
class Liwc():
    ...
    def iterable(self,corpus):
        LIWC_categories = {key:0 for key in self.categories.values()}
        rows = []
        N_shape = len(corpus)
    ...
    def _load_dict_file(self, filepath):
        liwc_file = open(filepath, encoding="utf-8")
...
def LIWC_SPANISH(corpus):
    return LIWC.iterable(corpus)